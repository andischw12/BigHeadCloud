...
public class GalleryLevelSelectionEditor : Editor
{
    ...
    private SerializedProperty items, autoGenerateItemsCount, itemsWidth, itemsHeight, galleryChild,
        ...
        freeSwipeColliderSize, navigateToClickedItems, linearScale, hasScaleTransition, hasDisplacementTransition, displacementType, linearColor, linearRotation, isScrollable;
    ...
    private void OnEnable()
    {
        ...
        isScrollable = serializedObject.FindProperty("isScrollable");
    }
    ...
    private void LayoutAndMovementSettings()
    {
        ...
        if (showLayoutAndMovement)
        {
            ...
            EditorGUILayout.PropertyField(isScrollable, new GUIContent("Is Scrollable"));
