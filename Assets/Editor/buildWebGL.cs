...
public class ExportWebGL : MonoBehaviour
{
    private static string[] levelsToPack = new string[] {
        "Assets/Scenes/Login.unity", "Assets/Scenes/Main Menu (Mobile)Andy.unity", "Assets/Scenes/Photon_Menu.unity", "Assets/Scenes/GameMultiPlayer.unity", "Assets/Scenes/PostGame.unity"
    };
